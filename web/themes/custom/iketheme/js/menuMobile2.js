document.addEventListener("DOMContentLoaded", function () {
  const mobileMenu = document.getElementById("block-iketheme-mainnavigation2-2"); // Mobile menu container
  const mobileMenuIcon = document.querySelector(".mobile-menu-icon a"); // Mobile menu trigger
  const topLevelItems = mobileMenu.querySelectorAll(".menu-level-0 > li"); // Top-level menu items
